...
if __name__ == "__main__":
    G = {'Wellington': {'Auckland':5, 'Hamiliton':5}, 'Auckland': {'Hamiliton':1, 'Rutorua':2}, 'Hamiliton': {'Rutorua':4}, 'Turanga':{'Rutorua':3, 'Auckland':9, 'Hamiliton':2}, 'Rutorua': {'Turanga':4}}
    print shortestPath(G, 'Wellington', 'Turanga')
