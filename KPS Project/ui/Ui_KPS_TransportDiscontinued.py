...
class Ui_TransportDiscontinued(object):
    def setupUi(self, TransportDiscontinued):
        ...
        TransportDiscontinued.setStyleSheet("background-color:rgb(8,129,2);Color: white;font-size:12px;")
        ...
        self.bt_AddEvent.setGeometry(QtCore.QRect(180, 320, 95, 23))
    ...
    def retranslateUi(self, TransportDiscontinued):
        ...
        self.bt_AddEvent.setText(_translate("TransportDiscontinued", "Remove Route", None))
