...
#
# Created: Sat May 10 13:46:45 2014
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollArea.setGeometry(QtCore.QRect(270, 40, 321, 111))
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName(_fromUtf8("scrollArea"))
        self.scrollAreaWidgetContents = QtGui.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 319, 109))
        self.scrollAreaWidgetContents.setObjectName(_fromUtf8("scrollAreaWidgetContents"))
        self.tableView = QtGui.QTableView(self.scrollAreaWidgetContents)
        self.tableView.setGeometry(QtCore.QRect(-10, 0, 331, 111))
        ...
        self.scrollArea_2.setGeometry(QtCore.QRect(20, 180, 261, 141))
        self.scrollArea_2.setWidgetResizable(True)
        self.scrollArea_2.setObjectName(_fromUtf8("scrollArea_2"))
        self.scrollAreaWidgetContents_2 = QtGui.QWidget()
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 259, 139))
        self.scrollAreaWidgetContents_2.setObjectName(_fromUtf8("scrollAreaWidgetContents_2"))
        self.tableView_2 = QtGui.QTableView(self.scrollAreaWidgetContents_2)
        self.tableView_2.setGeometry(QtCore.QRect(0, 0, 261, 141))
        ...
        self.scrollArea_3.setGeometry(QtCore.QRect(320, 180, 271, 141))
        self.scrollArea_3.setWidgetResizable(True)
        self.scrollArea_3.setObjectName(_fromUtf8("scrollArea_3"))
        self.scrollAreaWidgetContents_3 = QtGui.QWidget()
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 269, 139))
        self.scrollAreaWidgetContents_3.setObjectName(_fromUtf8("scrollAreaWidgetContents_3"))
        self.tableView_3 = QtGui.QTableView(self.scrollAreaWidgetContents_3)
        self.tableView_3.setGeometry(QtCore.QRect(0, 0, 271, 141))
        ...
        self.verticalScrollBar_3 = QtGui.QScrollBar(Dialog)
        self.verticalScrollBar_3.setGeometry(QtCore.QRect(590, 180, 16, 141))
        ...
        self.verticalScrollBar.setGeometry(QtCore.QRect(590, 40, 16, 111))
        self.verticalScrollBar.setOrientation(QtCore.Qt.Vertical)
        self.verticalScrollBar.setObjectName(_fromUtf8("verticalScrollBar"))
        self.verticalScrollBar_2 = QtGui.QScrollBar(Dialog)
        self.verticalScrollBar_2.setGeometry(QtCore.QRect(280, 180, 16, 141))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_7.setText(_translate("Dialog", "Amountof mail", None))
