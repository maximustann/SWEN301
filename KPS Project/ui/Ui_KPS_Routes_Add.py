...
# Form implementation generated from reading ui file 'KPS_Routes_Add.ui'
#
# Created: Mon Apr 21 15:26:19 2014
...
class Ui_Dialog(object):
    def setupUi(self, Form):
        ...
        Form.resize(386, 293)
        Form.setStyleSheet("background-color:rgb(8,129,2);Color: white;font-size:16px;")
        self.groupBox = QtGui.QGroupBox(Form)
        self.groupBox.setGeometry(QtCore.QRect(20, 20, 321, 291))
        ...
        self.bt_Add_Route = QtGui.QPushButton(self.groupBox)
        self.bt_Add_Route.setGeometry(QtCore.QRect(180, 230, 75, 23))
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(_translate("Form", "Add Route", None))
        self.groupBox.setTitle(_translate("Form", "Add Route Details", None))
